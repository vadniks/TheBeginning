...
//        internal infix fun isTablet(context: Context) = context.resources.configuration.screenLayout and
//                Configuration.SCREENLAYOUT_SIZE_MASK >= Configuration.SCREENLAYOUT_SIZE_LARGE
        infix fun isLanscape(context: Context) = context.resources.configuration.
    ...
    private inner class Adapter(private val arr: ArrayList<String>, private val block: MainActivity) :
        ...
        override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ViewHolder {
            ...
            viewHolder.itemView.setOnClickListener { _ ->
                if (!(MainActivity isLanscape this@MainActivity))
                    onClick2(viewHolder.adapterPosition)
                else
                    block.onClick(viewHolder.adapterPosition) }
            return viewHolder
        }
    ...
    private fun onClick2(id: Int) {
        val arr = this.resources.getStringArray(R.array.weather)
        startActivity(Intent(this@MainActivity, PortraitActivity::class.java)
                .putExtra("arr", arr)
                .putExtra("id", id))
    }
}
