...
public class Task7DD {
    ...
    static class Rnr {
        ...
        final int lg = ln / 2;
        final int mx = 106;
        LinkedList<Integer> pl1 = new LinkedList<>();
        LinkedList<Integer> pl2 = new LinkedList<>();
        int sps = 0;
        ...
        void prs() {
            ...
            for (int j = 0, l; j < 2; j++) {
                for (String i : sc.nextLine().split(" ")) {
                    ...
                    if (j == 0) pl1.add(l); else pl2.add(l);
                }
            }
            ccl();
        }
        ...
        */
        ...
        void ccl() {
            ...
            for (sps = 1; sps <= mx; sps++) {
                ...
                if (pl1.toArray().length == 0) {
                    System.out.println(sn + ' ' + sps);
                    System.out.println(pl1.toString() + ' ' + pl2);
                    return;
                } else if (pl2.toArray().length == 0) {
